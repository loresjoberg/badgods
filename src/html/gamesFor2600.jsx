...
<p>
	<span className="ratingheader">Pac-Man</span><br/>
	This was the great Atari 2600 betrayal. The hype surrounding this release was tremendous, fueled of course by the huge success of the arcade game. And when the cartridge was finally released, sliding it into the game console was like slipping a stiletto into your own back. The game was pitiful. Pac-Man was shaped like a video Wheat Thin, and instead of making cheerful munching sounds, he honked. The ghosts were blocky and flickery, and the colorful fruit had been replaced by a square "vitamin." Pathetic. <b>D-</b>
</p>
<p>
	<span className="ratingheader">Pitfall</span><br/>
	This may have been the biggest success of the whole drawn-out 2600 saga, as evidenced by the fact that survived its humble beginnings and lead to Pitfall II, Super Pitfall, Pitfall: The Mayan Adventure, Pitfall 3-D, Pit-Tris, Pitfall Kombat, Pitfall in Pink: Barbie's Jungle Shopping Quest, and the short-lived "Pitfall!" Saturday morning cartoon show (1984-85). Not bad for a game where the high point is standing on alligator noses. Certainly this was head and fedora above most of what else was being offered at the time, and it was kind of fun, but it didn't really have a big ending. You just collected all the treasures and it was over. No accolades, no drawn-out credit sequences, just no more game. <b>B-</b>
</p>
<p>
	<span className="ratingheader">Superman</span><br/>
	The first of about four hundred billion video games starring the Man of Steel, this took a lot of liberties with the Superman mythos. For instance, Superman was bald, and looked and sounded like a large wasp. Also, Kryptonite could, inexplicably, be counteracted by a kiss from Lois Lane, who was only too willing to supply the needed antidote and would keep on necking with you interminably if you picked her up. This was a basic low-key gather-some-things-and-avoid-other-things game of the sort that was mildly popular before computer resolution was high enough to accurately render arterial spray, but I liked it. <b>B</b>
</p>
<p>
	<span className="ratingheader">Combat</span><br/>
