...
<table>
	<tr>
		<td><img src={"/images/dndmonster-owlbear.jpg"} width="125" height="125" alt="[Owlbear]" /></td>
		<td> 
	...
	<tr>
		<td><img src={"/images/dndmonster-gelatinouscube.jpg"} width="125" height="125" alt="[Gelatinous Cube]" /></td>
		<td> 
		<p className="ratingheader">
			Gelatinous Cube
		</p>
	...
	<tr>
		<td><img src={"/images/dndmonster-trapper.jpg"} width="125" height="125" alt="[Trapper]" /></td>
		<td> 
		<p className="ratingheader">
			Trapper
		</p>
	...
	<tr>
		<td><img src={"/images/dndmonster-umberhulk.jpg"} width="125" height="125" alt="[Umber Hulk]" /></td>
		<td> 
		<p className="ratingheader">
			Umber Hulk
		</p>
	...
	<tr>
		<td><img src={"/images/dndmonster-mimic.jpg"} width="125" height="125" alt="[Mimic]" /></td>
		<td> 
		<p className="ratingheader">
			Mimic
		</p>
