...
<table>
	<tr valign="top">
		<td><img src={"/images/legodarth.gif"} width="100" height="100" alt="[ Lego Darth ]"/></td>
		<td>
		<p>
			<span className="ratingheader">Darth Vader</span><br/>
	...
	<tr valign="top">
		<td><img src={"/images/legoendortrooper.gif"} width="100" height="100" alt="[ Lego Endor Trooper ]"/></td>
		<td>
		<p>
			<span className="ratingheader">Forest Troopers</span><br/>
	...
	<tr valign="top">
		<td><img src={"/images/legobiggs.gif"} width="100" height="100" alt="[ Lego Biggs ]"/></td>
		<td>
		<p>
			<span className="ratingheader">Biggs</span><br/>
	...
	<tr valign="top">
		<td><img src={"/images/legoboba.gif"} width="100" height="100" alt="[ Lego Boba Fett ]"/></td>
		<td>
		<p>
			<span className="ratingheader">Boba Fett</span><br/>
	...
	<tr valign="top">
		<td><img src={"/images/legofrozenhan.gif"} width="100" height="100" alt="[ Lego Frozen Han ]"/></td>
		<td>
		<p>
			<span className="ratingheader">Frozen Han</span><br/>
	...
	<tr valign="top">
		<td><img src={"/images/legoluke.gif"} width="100" height="100" alt="[ Lego Luke ]"/></td>
		<td>
		<p>
			<span className="ratingheader">Tattooine Luke</span><br/>
