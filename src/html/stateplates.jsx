const stateplates = <div> 
<p>
	<span className="ratingheader">New Jersey</span><br/>
	New Jersey, in an act of unprecedented chutzpah, has apparently created a license plate commemorating smog. The perplexing thing is not just that the fading urine-yellow background looks like grimy smog on a summer day, but that it's hard to imagine what else it could possibly be meant to evoke. Even more odd are the special plates that have pictures of things like an American bald eagle in the smog, a lighthouse in the smog, and a cute little happy kitty and puppy in the smog. <b>D</b>
</p>
<p>
	<span className="ratingheader">Ohio</span><br/>
...
<p>
	<span className="ratingheader"></span><br/>
