...
<table>
	<tr>
		<td><img src={"/images/dndmonster-displacerbeast.jpg"} width="125" height="125" alt="[Displacer Beast]" /></td>
		<td> 
	...
	<tr>
		<td><img src={"/images/dndmonster-beholder.jpg"} width="125" height="125" alt="[Beholder]" /></td>
		<td> 
		<p className="ratingheader">
			Beholder
		</p>
	...
	<tr>
		<td><img src={"/images/dndmonster-rustmonster.jpg"} width="125" height="125" alt="[Rust Monster]" /></td>
		<td> 
		<p className="ratingheader">
			Rust Monster
		</p>
	...
	<tr>
		<td><img src={"/images/dndmonster-blinkdog.jpg"} width="125" height="125" alt="[Blink Dog]" /></td>
		<td> 
		<p className="ratingheader">
			Blink Dog
		</p>
	...
	<tr>
		<td><img src={"/images/dndmonster-githyanki.jpg"} width="125" height="125" alt="[Githyanki]" /></td>
		<td> 
		<p className="ratingheader">
			Githyanki
		</p>
