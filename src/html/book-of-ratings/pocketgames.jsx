...
<div>
	<div>
		<div><img className={"ratingsImage"} src={"/images/book-of-ratings/pocketgame-caterpillar.jpg"} alt=""/></div>
		<div>
		<h3 className="ratingsHeader">Catch a Caterpillar</h3>
<p>
			I remember this game from the early 80s, when the video game Centipede was supernova hot, so hot indeed that Tomy made a stupid little plastic game with a transparent Centipede theme. Unlike Centipede, in which you dismember an insect with callous efficiency, Catch a Caterpillar challenges you to <em>assemble</em> an insect from individual insect pieces, also known as "BBs," making the game more like a combination of Cootie and Gothic horror than a video game. According to the instructions, you "release shooter to fire, aiming into center opening," which sounds great except you can't actually aim. You just shoot one BB after another, hoping the mysterious power of magnetism will cause them to stick together. <b>D</b>
		</p>
		</div>
	</div>
	<div>
		<div><img className={"ratingsImage"} src={"/images/book-of-ratings/pocketgame-dragontrap.jpg"} alt=""/></div>
		<div>
