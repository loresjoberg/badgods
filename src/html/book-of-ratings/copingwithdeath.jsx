const copingwithdeath = <div> 
<h3 className="ratingsHeader">Denial</h3>
<p className="ratingbody">
	It's a shame you can't ride this one out right up to the end. When I'm lying in bed at night and I'm suddenly clenched in the grip of the terrible knowledge of my own inevitable mortality, my usual coping mechanism is to assume I'm going to get hit by a bus. Assuming the bus driver is competent enough to kill me instantly, that relieves me of any need to acknowledge the possibility that I might not live to see Alpha Centauri colonized or leg warmers come back into fashion. <span className="ratinggrade">A</span>
</p>
<h3 className="ratingsHeader">Anger</h3>
<p className="ratingbody">
...
<p className="ratingbody">
	"Do not go gently into that good night" sounds all well and good when you're popping by to get some poetic inspiration, but I imagine at some point most of the survivors would like the dying person to at least go, if not gently, then at least reasonably politely. <span className="ratinggrade">C-</span>
</p>
<h3 className="ratingsHeader">Bargaining</h3>
<p className="ratingbody">
...
<p className="ratingbody">
	While I find a certain amount of inexplicable charm in the idea of God saying "Look, you want this brain tumor in remission, and I want to give you that. I really do. But you're going to have to do better than a couple bags of canned goods," I think the more precise term for this stage is "Grasping at straws." <span className="ratinggrade">D</span>
</p>
<h3 className="ratingsHeader">Depression</h3>
<p className="ratingbody">
...
<p className="ratingbody">
	Hint to photographers bucking for a Pulitzer: this is the best stage to get your shots in. The slack jaw and air of resignation, the concerned, hand-patting family, the neatly tucked sheets--it's <em>pure gold, baby</em>! <span className="ratinggrade">C</span>
</p>
<h3 className="ratingsHeader">Acceptance</h3>
<p className="ratingbody">
	I'm glad to see that this is the final stage. It would be a bummer if "Acceptance" was followed by "Regret" or "Karaoke." As it is, though, your archetypical bucket-kicker gets to spend his or her last few days or hours or picoseconds appreciating birdsong and working on a catchy tombstone motto. They still end up equally dead, though. <span className="ratinggrade">B</span>
</p>
</div>

export default copingwithdeath;