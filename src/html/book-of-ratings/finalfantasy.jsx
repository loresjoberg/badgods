const finalfantasy = <div><h3 className="ratingsHeader">Chocobos</h3>
...
<h3 className="ratingsHeader">Moogles</h3>
<p className="ratingbody">
...
<h3 className="ratingsHeader">Cid</h3>
<p className="ratingbody">
...
<h3 className="ratingsHeader">Summoning</h3>
<p className="ratingbody">
...
<h3 className="ratingsHeader">Fire/Thunder/Blizzard</h3>
<p className="ratingbody">
...
<h3 className="ratingsHeader">The Ultimate Attack</h3>
<p className="ratingbody">
