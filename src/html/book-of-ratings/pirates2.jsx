const pirates2 = <div><h3 className="ratingsHeader">Peg Legs</h3>
<p className="ratingbody">
	You'd think that a group of people prone to decorating themselves with gold earrings and fancy scarves would want something a little more interesting than a wooden leg-dowel to replace their lost limb. Maybe something in silver with ruby toenails. Sure, it requires a little more effort to take proper care of it, but you can't sodomize the cabin boy 24/7. <span className="ratinggrade">C-</span>
</p>
<h3 className="ratingsHeader">Floppy Hat</h3>
<p className="ratingbody">
	I suspect that a couple days in the sea air would leave an ostrich plume looking like the detached tail of a mangy Afghan hound, but I'm no expert on plumage, sailing, or foppery. I do know this, though: a pirate crew clearly needs strong leadership, and nothing inspires morale like a captain who looks like a drag queen after a clearance sale at Chet's House of Velvet and Maribou. Show up to work in a pair of chinos and a nice denim shirt and you'll be kissing the gunner's daughter faster than you can say "Reginald Dwight." <span className="ratinggrade">B</span>
</p>
<h3 className="ratingsHeader">Alchoholism</h3>
<p className="ratingbody">
