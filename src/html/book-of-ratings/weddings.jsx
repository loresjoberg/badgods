const weddings = <div> 
<h3 className="ratingsHeader">The Garter</h3>
<p>
...
<h3 className="ratingsHeader">The Shoving of the Cake</h3>
<p>
	What's a lifelong commitment without a bit of slapstick? While we're at it, why not have the flower girl throw banana peels, hand the reception line cream pies to throw, and have the person performing the ceremony refer to the bridal couple as "youse guys"? <b>D</b>
</p>
<h3 className="ratingsHeader">The Part Where You Speak Now Or Forever Hold Your Peace</h3>
<p>
	It's very thoughtful of early wedding arrangers to provide a handy moment of suspense for Hollywood to take advantage of. In dramas, this is where the tragic lover reveals her true feelings, in comedies this is where the wacky mother-in-law to be delights the audience with a sassy outburst, and in science fiction...well, I can't remember any notable science fiction movie weddings, but there's room for something really great there. <b>B-</b>
</p>
<h3 className="ratingsHeader">The Best Man</h3>
<p>
	Hey, any excuse to wear a tuxedo. Actually, these days it's about the <em>only</em> post-prom excuse to wear a tuxedo, unless you count being a British Secret Service agent at the Baccarat table. Plus you get to make a toast, which is fun as long as you don't screw up and call the groom beautiful and the bride lucky. <b>A</b>
</p>
<h3 className="ratingsHeader">Something Old, Something New, Something Borrowed, Something Blue</h3>
<p>
