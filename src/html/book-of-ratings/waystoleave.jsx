...
<h3 className="ratingsHeader">No Need To Be Coy, Roy, Just Listen To Me</h3>
<p>
	At this point we seem to have abandoned all pretense of actual lover-leaving in favor of vague personality-building advice. This is seeming less like useful information and more like an infomercial for an expensive partner-abandonment seminar. "Just three payments of fifty-nine ninety-five, Clive." <b>D-</b>
</p>
<h3 className="ratingsHeader">Hop On The Bus, Gus</h3>
<p>
	Finally we're getting back to an actual way to leave your lover. Not a good way, but a way nonetheless. The problem with the bus is that you generally have to wait around a while before hopping on it, which give you time to rethink things and your lover time to track you down like a jilted bloodhound. I'm not sure whether "Don't need to discuss much" is an addendum to this piece of advice or a preface to the next one, so I'm ignoring it. <b>C-</b>
</p>
<h3 className="ratingsHeader">Just Drop Off the Key, Lee</h3>
<p>
	Now, you see, this is thoughtful. It's a wonderful way to say "The way you sound like a toy duck when you sneeze has driven me away, but that doesn't mean I don't care." Then, when your lover writes a tell-all autobiography, your chapter will be entitled "The Traitorous Deceiving Asshole" rather than "The Heartless Traitorous Deceiving Asshole." <b>B+</b>
</p>
</div>

export default waystoleave;