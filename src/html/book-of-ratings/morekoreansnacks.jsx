			...
			"The 'POP' Snack is so servieeable to children's snack because of its softness and taste popped from the main ingredient of the snack rice." 
				...
				"By chance when you can change them at business offices or nearby stores where you had pur chsed them." 
					...
					"Let's establish health society by abolishing inferior food." 
						...
						I don't know about you, but I'm ready to start establishing health society even as we speak. <b>C-</b>
					</p>
					<h3 className="ratingsHeader">Pumpkin Candy</h3>
<p>
						This claims to be pumpkin flavored, but the wrapping depicts some sort of generic green gourd. I don't really know what generic green gourds taste like, but if they taste like semi-raw, slightly off pumpkins, then this candy is spot on. <b>C-</b>
					</p>
</div>

export default morekoreansnacks;