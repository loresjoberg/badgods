const goodluck = <div> 
<h3 className="ratingsHeader">Horseshoe</h3>
<p>
	Sure, why not. There's probably some goddess-crescent connection here, and if there isn't I'm sure there are plenty of liberal arts undergrads willing to make one up. My favorite part is how you're supposed to keep your lucky horseshoe's ends up "to keep the luck from pouring out." Because you don't want to have a doorstep covered in luck which will enter the sewage system during the next rain and drain to the ocean, resulting in unnaturally fortunate salmon. The resulting devastating impact on the ecosystem is easy to envision. So watch it. <b>B</b>
</p>
<h3 className="ratingsHeader">Rabbit Foot</h3>
<p>
