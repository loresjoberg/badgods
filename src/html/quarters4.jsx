...
<table>
	<tr>
		<td><img src={"/images/coin-tn.jpg"} width="125" height="125" alt="[Tennessee Coin]" /></td>
		<td> 
	...
	<tr>
		<td><img src={"/images/coin-oh.jpg"} width="125" height="125" alt="[Ohio Coin]" /></td>
		<td> 
		<p className="ratingheader">
			Ohio
		</p>
	...
	<tr>
		<td><img src={"/images/coin-la.jpg"} width="125" height="125" alt="[Louisiana Coin]" /></td>
		<td> 
		<p className="ratingheader">
			Louisiana 
		</p>
	...
	<tr>
		<td><img src={"/images/coin-in.jpg"} width="125" height="125" alt="[Indiana Coin]" /></td>
		<td> 
		<p className="ratingheader">
			Indiana
		</p>
	...
	<tr>
		<td><img src={"/images/coin-ms.jpg"} width="125" height="125" alt="[Mississippi Coin]" /></td>
		<td> 
		<p className="ratingheader">
			Mississippi
		</p>
